                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="question-title">
                            ...
                            <h6>Create a new class and start inviting students to track their progress</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="album py-5">
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <form action="modules/new_class.php" method="post">
                        <label for="classname">Class Name:‎‎ <required title="This field is required">*</required></label>
                        <br>
                        <input class="form-input" type="text" id="class_name" name="class_name" placeholder="Example: 10_A" required>
                        <br><br>
                        <input type="submit" value="Create new Class" style="color: white" class="btn btn-primary btn-round btn-simple"></a>
                    </form>
