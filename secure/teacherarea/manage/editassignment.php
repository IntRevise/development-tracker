                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="question-title">
                            ...
                            <h6>Edit information or details on an assignment created by you</h6>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="contact pb-60" style="margin-top: 50px">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                <form action="modules/edit_assignment.php">

                    <label for="classname">Assignment Title:‎‎ <required title="This field is required">*</required></label>
                    <br>
                    <input class="form-input" type="text" id="asgn_title" name="asgn_title" value="<?=getData("assignments", "title", "id", $asgn)?>" required>
                    <br><br>

                    <label for="classname">Assignment Description:‎‎ <required title="This field is required">*</required></label>
                    <br>
                    <textarea class="form-textarea" type="text" id="asgn_desc" name="asgn_desc" required><?=getData("assignments", "description", "id", $asgn)?></textarea>
                    <br><br>

                    <label for="classname">Due Date:‎‎ <required title="This field is required">*</required></label>
                    <br>
                    <input class="form-input" type="date" id="asgn_date" name="asgn_date" value="<?= convertDate(getData("assignments", "dueDate", "id", $asgn), "Y-m-d") ?>" required>
                    <br><br>
                    ...
                    <select class="form-input" name="asgn_class" id="asgn_class" required>
                        ...
                        ?>
                            <option name="asgn_class" value="<?= $row['classId'] ?>"><?= $row['className'] . " &bull; " . $row['classId'] ?></option>
                        <?php
                        }
                    ...
                    <input type="submit" value="Save Assignment" style="color: white" class="btn btn-primary btn-round btn-simple"></a>
                </form>
