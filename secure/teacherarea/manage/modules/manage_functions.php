...
function errorHandler()
{
    ...
    } elseif ($_GET['success'] == "classCreated") {
        $error = "false";
        $msg = "Successfully created a new class! You can now invite students with the generated class code.";
    } elseif ($_GET['success'] == "assignmentPosted") {
        $error = "false";
        $msg = "Successfully created and posted new assignment! Students will see the assignment on the student dashboard.";
    }
...
function getProfilePicture($id)
{
    if (file_exists("../../../assets/usercontent/" . $id . ".png")) {
        echo "../../../assets/usercontent/" . $id . ".png?update=" . date('s-ms');
    }
    if (file_exists("../../../assets/usercontent/" . $id . ".jpg")) {
        echo "../../../assets/usercontent/" . $id . ".jpg?update=" . date('s-ms');
    }
    if (file_exists("../../../assets/usercontent/" . $id . ".jpeg")) {
        echo "../../../assets/usercontent/" . $id . ".jpeg?update=" . date('s-ms');
    }
    if (file_exists("../../../assets/usercontent/" . $id . ".gif")) {
        echo "../../../assets/usercontent/" . $id . ".gif?update=" . date('s-ms');
    }
}
...
class getStat
{
    ...
    public function getClassesPersonal()
    {
        require $_SERVER['DOCUMENT_ROOT'] . "/lab/int-revise/modules/_dblogin.php";
        $con = mysqli_connect($DATABASE_HOST, $DATABASE_USER, $DATABASE_PASS, $DATABASE_NAME);
        if (mysqli_connect_errno()) {
...
function noClassesCheck($msg)
{
    $stat = new getStat();
    if ($stat->getClassesPersonal() == 0) { ?>
        <div class="col-sm-12">
            <div class="alert fade alert-simple alert-danger alert-dismissible text-left font__family-montserrat font__size-16 font__weight-light brk-library-rendered rendered show" role="alert" data-brk-library="component__alert">
                <i class="start-icon fa fa-exclamation-triangle faa-flash animated"></i>
                <strong class="font__weight-semibold">Error!</strong> <?=$msg?>
            </div>
        </div>
<?php
        exit;
