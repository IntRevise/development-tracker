...
<head>
    ...
    <title>Error 404 - IntRevise</title>
                    ...
                    <div class="row row-padding">
                        <div class="col-xl-7 col-lg-6 col-md-6">
                            <div class="header-content-body" style="padding-bottom: 80px;">
                                <h1>Error <span class="bold-color">404<br></span></h1>
                                <p>You seem lost.. The requested page could not be found. <br>It may have been removed, renamed, or was moved somewhere else!</p>
                                <br>
                                <div>
