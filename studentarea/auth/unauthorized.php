...
<head>
    ...
    <title>Account Unlinked - IntRevise</title>
                    ...
                    <div class="row row-padding">
                        <div class="col-xl-7 col-lg-6 col-md-6">
                            <div class="header-content-body" style="padding-bottom: 80px;">
                                <h1><img draggable="false" src="<?= decode($_GET['avatar']) ?>" style="max-height:80px;border-radius:50px" <?= onError("https://cdn.surge-networks.co.uk/uploads/default-discord-avatar.png") ?>> Thank You!</h1>
                                <p>Your <?= decode($_GET['link_type']) ?> account, <b><?= decode($_GET['username']) . "#" . decode($_GET['discriminator']) ?></b>, has successfully been unlinked from your IntRevise account, <b><?= decode($_GET['accountName']) ?></b>. If you wish, you can relink the account <a href="https://discord.com/oauth2/authorize?client_id=867211933056761868&response_type=code&scope=identify">here</a>.</p>
                                <br>
                                <pre><code>Username: <b><?= decode($_GET['username']) . "#" . decode($_GET['discriminator']) ?></b>
