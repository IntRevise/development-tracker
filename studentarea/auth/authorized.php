                    ...
                    <div class="row row-padding">
                        <div class="col-xl-7 col-lg-6 col-md-6">
                            <div class="header-content-body" style="padding-bottom: 80px;">
                                <h1><img draggable="false" src="<?= decode($_GET['avatarUrl']) ?>" style="max-height:80px;border-radius:50px" <?= onError("https://cdn.surge-networks.co.uk/uploads/default-discord-avatar.png") ?>> Thank You!</h1>
                                <p>Your <?= decode($_GET['link_type']) ?> account, <b><?= decode($_GET['username']) . "#" . decode($_GET['discriminator']) ?></b>, has successfully been linked to your IntRevise account, <b><?= decode($_GET['accountName']) ?></b>.</p>
                                <br>
                                <pre><code>Username: <b><?= decode($_GET['username']) . "#" . decode($_GET['discriminator']) ?></b><br>
Avatar: <b><?= decode($_GET['avatar']) ?></b><br>
User ID: <b><?= decode($_GET['id']) ?></b><br>
Linked To: <b><?= decode($_GET['accountName']) ?> (<?= getData("accounts", "id", "username", decode($_GET['accountName'])) ?>)</b><br>
