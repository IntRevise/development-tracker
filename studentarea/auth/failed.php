                    ...
                    <div class="row row-padding">
                        <div class="col-xl-7 col-lg-6 col-md-6">
                            <div class="header-content-body" style="padding-bottom: 80px;">
                                <h1><img draggable="false" src="<?= decode($_GET['avatarUrl']) ?>" <?= onError("https://cdn.surge-networks.co.uk/uploads/default-discord-avatar.png") ?> style="max-height:80px;border-radius:50px"> <?= decode($_GET['et']) ?></h1>
                                <p><?= decode($_GET['ed']) ?></p>
                                <br>
                                <pre><code class="language-html"><?= decode($_GET['ec']) ?></code></pre>
                                <br>
                                <div>
